...
'Hello, Facebook is telling that you are %(first_name)s %(last_name)s': 'Ciao, Facebook dice che tu sei %(first_name)s %(last_name)s',
...
'Login': 'Login',
'Looking list of %(conn_name)s of %(id)': 'Looking list of %(conn_name)s of %(id)',
'Looking list of %(conn_name)s of %(id)s': 'Looking list of %(conn_name)s of %(id)s',
'Main Menu': 'Main Menu',
